                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        ...
                        if (isset($_SESSION['username'])) {
                            echo "<a class='nav-link' href='./users_area/user_resgistration.php'>My Account</a>";
                        } else {
                            echo "<a class='nav-link' href='./users_area/user_resgistration.php'>Register</a>";
                        }
                        ?>
                    </li>
                    <li class="nav-item">
  ...
  <div class="col-md-2 bg-secondary p-0">
    <!--displayed brands-->
     <ul class="navbar-nav me-auto text-center">
      ...
      <a href="#" class="nav-link text-light"><h4>Brands</a></h4>  
      </li>
      <?php
       getbrands();
      ?>
      ...
      <ul class="navbar-nav me-auto text-center">
      <li class="nav-item bg-info">
      <a href="#" class="nav-link text-light"><h4>Category</a></h4>  
      </li>
      <?php
getcategories();
?>
